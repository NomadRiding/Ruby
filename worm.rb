...
class Worm
  ...
  def draw_split win, split
	win.draw_quad split[0]*$size, split[1]*$size, Color::RED,
                  split[0]*$size+$size, split[1]*$size, Color::GREEN,
                  split[0]*$size+$size, split[1]*$size+$size, Color::YELLOW,
                  split[0]*$size, split[1]*$size+$size, Color::BLUE
  end 
  def draw win
  	draw_split win, @food
